...
def test_fim_s_TEST_CASE_6_FIMS_CNN_subcase_1a(test_name,load_scenario_data,scenarios,fetch_docker_details,run_docker_script,fetch_notebook_location_details,fetch_txt_details,remove_file):
    tn = test_name + '.json'
